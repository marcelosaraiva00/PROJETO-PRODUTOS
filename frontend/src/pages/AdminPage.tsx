                            ...
                            <td className="px-6 py-5 align-top text-sm font-medium">
                              <div className="flex space-x-2">
                                <button
                                  ...
                                  className="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-700 transition-all shadow-md hover:shadow-lg disabled:bg-green-200 disabled:text-green-900 disabled:border disabled:border-green-300 disabled:opacity-70 disabled:cursor-not-allowed"
                                >
                                ...
                                <button
                                  ...
                                  className="inline-flex items-center px-4 py-2 bg-red-600 text-white rounded-lg font-semibold hover:bg-red-700 transition-all shadow-md hover:shadow-lg disabled:bg-red-200 disabled:text-red-900 disabled:border disabled:border-red-300 disabled:opacity-70 disabled:cursor-not-allowed"
                                >
